        ...
        <center class="mx-5 px-5 mt-5 pt-3">
            ...
            <form style="width: 50%">
                <div class="mb-3 text-start">
                    ...
                    <input type="text" class="form-control border border-dark" value="Gitsa Zahira Shafa">
                </div>
                <div class="mb-3 text-start">
                    <label class="form-label fw-semibold">Email</label>
                    <input type="email" class="form-control border border-dark" value="gitsa@gmail.com">
                </div>
                <div class="mb-3 text-start">
                    <label class="form-label fw-semibold">Password</label>
                    <input type="password" class="form-control border border-dark" value="password">
                </div>
                <div class="mb-3 text-start">
                ...
                <div class="mb-3 text-start">
                    ...
                    <input type="number" class="form-control border border-dark" value="0811222334455">
                </div>
